          ...
          <form onSubmit={handleSearch} className="mb-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent placeholder-gray-500"
            ...
            <button
              ...
              className="w-full mt-4 bg-purple-600 text-white py-3 px-4 rounded-lg hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
            >
              {isSearching ? (
                <>
                      ...
                      >
                        <div className="flex items-start justify-between mb-1">
                          ...
                          <span className="text-xs text-gray-500">
                            {new Date(result.source.timestamp).toLocaleDateString()}
                          </span>
                        </div>
